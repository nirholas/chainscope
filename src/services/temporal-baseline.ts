...
const TYPE_LABELS: Record<TemporalEventType, string> = {
  military_flights: 'Whale transactions',
  tracked_flights: 'Whale transactions',
  vessels: 'Protocol activity',
  protests: 'Governance proposals',
  news: 'News velocity',
  ais_gaps: 'Dark wallet activity',
  satellite_fires: 'On-chain anomaly detections',
};
