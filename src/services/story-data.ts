import { calculateRiskScores, type CountryScore } from './country-instability';
...
export function collectStoryData(
  ...
  signals?: { protests: number; trackedFlights: number; trackedVessels: number; outages: number },
  ...
  return {
    ...
    signals: signals || { protests: 0, trackedFlights: 0, trackedVessels: 0, outages: 0 },
