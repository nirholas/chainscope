...
import { FOCUS_AREAS } from '@/config';
...
export async function fetchProtestEvents(): Promise<ProtestData> {
  ...
  // Note: Data freshness is recorded in App.ts AFTER ingestProtests()
  // to avoid race conditions where the Strategic Risk panel refreshes before risk data is ingested
