import type { Hotspot, RiskRegion, TrackedFacility, UnderseaCable, EnergyFacility, KeyWaterway, APTGroup, EconomicCenter, Spaceport, CriticalMineralProject } from '@/types';
...
// Trend scores: 1=stable, 2=watchlist, 3=elevated, 4=high tension, 5=critical
export const FOCUS_AREAS: Hotspot[] = [
  {
    id: 'sahel',
    name: 'Sahel',
...
export const KEY_WATERWAYS: KeyWaterway[] = [
  { id: 'taiwan_strait', name: 'TAIWAN STRAIT', lat: 24.0, lon: 119.5, description: 'Critical shipping lane' },
  { id: 'malacca_strait', name: 'MALACCA STRAIT', lat: 2.5, lon: 101.5, description: 'Major oil shipping route' },
  { id: 'hormuz_strait', name: 'STRAIT OF HORMUZ', lat: 26.5, lon: 56.5, description: 'Oil chokepoint' },
  { id: 'bosphorus', name: 'BOSPHORUS STRAIT', lat: 41.1, lon: 29.0, description: 'Black Sea access' },
  ...
  { id: 'gibraltar', name: 'STRAIT OF GIBRALTAR', lat: 35.9, lon: -5.6, description: 'Mediterranean access' },
  { id: 'bab_el_mandeb', name: 'BAB EL-MANDEB', lat: 12.5, lon: 43.3, description: 'Red Sea chokepoint' },
  { id: 'dardanelles', name: 'DARDANELLES', lat: 40.2, lon: 26.4, description: 'Aegean-Marmara link' },
];
...
export const RISK_REGIONS: RiskRegion[] = [
  {
    id: 'ukraine',
...
// Domestic facilities (not in overseas dataset)
const US_DOMESTIC_BASES: TrackedFacility[] = [
...
function mergeAndDeduplicateBases(): TrackedFacility[] {
...
// Combined tracked facilities: 210 from ASIAR dataset + unique domestic
// Total: ~220 facilities from 9 operators
export const TRACKED_FACILITIES: TrackedFacility[] = mergeAndDeduplicateBases();
...
export const FLAGGED_COUNTRIES: Record<number, 'severe' | 'high' | 'moderate'> = {
