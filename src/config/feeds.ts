...
export const SOURCE_TIERS: Record<string, number> = {
  ...
  // Tier 3 - Exchange & Protocol Blogs
  'Coinbase Blog': 3,
  'Multicoin Capital': 3,
  'Messari': 3,
  'Paradigm': 3,
  ...
  'CBC News': 2,
  'Forbes': 3,
  'Economic Times India': 3,
  'Investopedia': 3,
  'DailyFX': 3,

  // Tier 3 - Chinese State (geopolitical context)
  'China Daily': 3,
  'Global Times': 3,
...
export const SOURCE_TYPES: Record<string, SourceType> = {
  ...
  'Financial Times': 'market', 'WSJ': 'market', 'Forbes': 'market',
  'The Economist': 'market', 'Investopedia': 'market', 'DailyFX': 'market',
  'Economic Times India': 'market', 'NYT': 'mainstream', 'Washington Post': 'mainstream',
  'Nikkei Asia': 'market', 'DW News': 'mainstream', 'CBC News': 'mainstream',

  // Crypto
  'CoinDesk': 'market', 'CoinTelegraph': 'market', 'Decrypt': 'market',
  'The Block': 'market', 'Bitcoin Magazine': 'market',
  'CryptoSlate': 'market', 'CryptoPotato': 'market', 'Bitcoinist': 'market',
  'NewsBTC': 'market', 'CryptoBriefing': 'market', 'The Daily Hodl': 'market',
  'DailyCoin': 'market', 'U.Today': 'market', 'Blockonomi': 'market',
  'CryptoNews.com': 'market', 'DeFi Pulse': 'market', 'The Defiant': 'market',
  'Bankless': 'market', 'DL News': 'market', 'Unchained Crypto': 'market',
  'Coinbase Blog': 'market', 'Multicoin Capital': 'market', 'Messari': 'market',
  'Paradigm': 'market', 'a16z Crypto': 'market',

  // Chinese State (geopolitical context)
  'China Daily': 'wire', 'Global Times': 'wire',

  // Tech
  'Hacker News': 'tech', 'Ars Technica': 'tech', 'The Verge': 'tech',
  'The Verge AI': 'tech', 'MIT Tech Review': 'tech',
...
export const SOURCE_PROPAGANDA_RISK: Record<string, SourceRiskProfile> = {
  ...
  'China Daily': { risk: 'high', stateAffiliated: 'China', note: 'CCP state newspaper, English edition' },
  'Global Times': { risk: 'high', stateAffiliated: 'China', note: 'CCP tabloid, hawkish foreign policy line' },
...
const FULL_FEEDS: Record<string, Feed[]> = {
  politics: [
    ...
    { name: 'Politico', url: rss('https://news.google.com/rss/search?q=site:politico.com+when:2d&hl=en-US&gl=US&ceid=US:en') },
  ...
  finance: [
    ...
    { name: 'MarketWatch', url: rss('https://news.google.com/rss/search?q=site:marketwatch.com+when:2d&hl=en-US&gl=US&ceid=US:en') },
    ...
    { name: 'WSJ', url: rss('https://news.google.com/rss/search?q=site:wsj.com+markets+OR+economy+when:2d&hl=en-US&gl=US&ceid=US:en') },
    { name: 'NYT', url: rss('https://news.google.com/rss/search?q=site:nytimes.com+business+OR+economy+when:2d&hl=en-US&gl=US&ceid=US:en') },
    { name: 'Washington Post', url: rss('https://news.google.com/rss/search?q=site:washingtonpost.com+business+OR+economy+when:2d&hl=en-US&gl=US&ceid=US:en') },
    { name: 'The Economist', url: rss('https://news.google.com/rss/search?q=site:economist.com+economy+OR+markets+when:3d&hl=en-US&gl=US&ceid=US:en') },
    { name: 'Forbes', url: rss('https://news.google.com/rss/search?q=site:forbes.com+markets+OR+economy+when:2d&hl=en-US&gl=US&ceid=US:en') },
    { name: 'Investopedia', url: rss('https://news.google.com/rss/search?q=site:investopedia.com+markets+when:3d&hl=en-US&gl=US&ceid=US:en') },
    { name: 'DailyFX', url: rss('https://news.google.com/rss/search?q=site:dailyfx.com+forex+OR+markets+when:3d&hl=en-US&gl=US&ceid=US:en') },
  ...
  thinktanks: [
    ...
    { name: 'RUSI', url: rss('https://news.google.com/rss/search?q=site:rusi.org+when:7d&hl=en-US&gl=US&ceid=US:en') },
  ...
  regional: [
    ...
    { name: 'CBC News', url: rss('http://www.cbc.ca/cmlink/1.1244475') },
    { name: 'DW News', url: rss('http://rss.dw.com/xml/rss-en-all') },
  ],
  africa: [
  ...
  asia: [
    ...
    { name: 'Nikkei Asia', url: rss('https://news.google.com/rss/search?q=site:asia.nikkei.com+when:2d&hl=en-US&gl=US&ceid=US:en') },
    { name: 'Economic Times India', url: rss('https://news.google.com/rss/search?q=site:economictimes.indiatimes.com+markets+when:2d&hl=en-US&gl=US&ceid=US:en') },
    { name: 'China Daily', url: rss('https://news.google.com/rss/search?q=site:chinadaily.com.cn+when:2d&hl=en-US&gl=US&ceid=US:en'), propagandaRisk: 'high', stateAffiliated: 'China' },
    { name: 'Global Times', url: rss('https://news.google.com/rss/search?q=site:globaltimes.cn+when:2d&hl=en-US&gl=US&ceid=US:en'), propagandaRisk: 'high', stateAffiliated: 'China' },
  ],
  energy: [
  ...
  // ── Crypto & DeFi ─────────────────────────────────────────────
  crypto: [
    // Tier 2 — Major crypto newsrooms
    { name: 'CoinTelegraph', url: rss('https://cointelegraph.com/feed') },
    ...
    { name: 'DL News', url: rss('https://news.google.com/rss/search?q=site:dlnews.com+crypto+OR+DeFi+when:3d&hl=en-US&gl=US&ceid=US:en') },
    // Tier 3 — Established crypto media
    { name: 'CryptoSlate', url: rss('https://news.google.com/rss/search?q=site:cryptoslate.com+when:3d&hl=en-US&gl=US&ceid=US:en') },
    { name: 'CryptoPotato', url: rss('https://cryptopotato.com/feed') },
    { name: 'Bitcoinist', url: rss('https://bitcoinist.com/feed/') },
    { name: 'NewsBTC', url: rss('https://www.newsbtc.com/feed/') },
    { name: 'CryptoBriefing', url: rss('https://cryptobriefing.com/feed/') },
    { name: 'The Daily Hodl', url: rss('https://dailyhodl.com/feed/') },
    { name: 'U.Today', url: rss('https://u.today/rss') },
    { name: 'DailyCoin', url: rss('https://news.google.com/rss/search?q=site:dailycoin.com+crypto+when:3d&hl=en-US&gl=US&ceid=US:en') },
    { name: 'CryptoNews.com', url: rss('https://cryptonews.com/news/feed/') },
    { name: 'Blockonomi', url: rss('https://news.google.com/rss/search?q=site:blockonomi.com+when:3d&hl=en-US&gl=US&ceid=US:en') },
  ],
  defi: [
    // DeFi-native sources
    { name: 'The Defiant', url: rss('https://thedefiant.io/feed') },
    { name: 'Bankless', url: rss('https://www.bankless.com/rss/feed') },
    { name: 'Unchained Crypto', url: rss('https://unchainedcrypto.com/feed/') },
    { name: 'DeFi Pulse', url: rss('https://news.google.com/rss/search?q=("DeFi"+OR+"decentralized+finance"+OR+"total+value+locked"+OR+TVL)+when:2d&hl=en-US&gl=US&ceid=US:en') },
    // Crypto VC & Research
    { name: 'a16z Crypto', url: rss('https://news.google.com/rss/search?q=("a16z+crypto"+OR+"Andreessen+Horowitz"+crypto+OR+web3)+when:7d&hl=en-US&gl=US&ceid=US:en') },
    { name: 'Multicoin Capital', url: rss('https://multicoin.capital/rss.xml') },
    { name: 'Messari', url: rss('https://news.google.com/rss/search?q=site:messari.io+OR+"Messari+crypto"+when:7d&hl=en-US&gl=US&ceid=US:en') },
    { name: 'Paradigm', url: rss('https://news.google.com/rss/search?q=("Paradigm"+crypto+OR+web3+OR+DeFi)+research+when:14d&hl=en-US&gl=US&ceid=US:en') },
    { name: 'Coinbase Blog', url: rss('https://news.google.com/rss/search?q=site:coinbase.com+OR+%22Coinbase%22+crypto+when:7d&hl=en-US&gl=US&ceid=US:en') },
    // On-chain & regulation
    { name: 'Crypto Regulation', url: rss('https://news.google.com/rss/search?q=(crypto+regulation+OR+SEC+crypto+OR+"digital+assets"+law+OR+MiCA)+when:3d&hl=en-US&gl=US&ceid=US:en') },
    { name: 'Stablecoin News', url: rss('https://news.google.com/rss/search?q=(stablecoin+OR+USDT+OR+USDC+OR+Tether+OR+"stablecoin+regulation")+when:3d&hl=en-US&gl=US&ceid=US:en') },
    { name: 'Bitcoin ETF', url: rss('https://news.google.com/rss/search?q=("Bitcoin+ETF"+OR+"Ethereum+ETF"+OR+"crypto+ETF"+OR+"spot+ETF")+when:3d&hl=en-US&gl=US&ceid=US:en') },
  ],
};
...
const TECH_FEEDS: Record<string, Feed[]> = {
  ...
  finance: [
    ...
    { name: 'MarketWatch Tech', url: rss('https://news.google.com/rss/search?q=site:marketwatch.com+technology+when:2d&hl=en-US&gl=US&ceid=US:en') },
...
export const RESEARCH_SOURCES: Feed[] = [
  // Geopolitical & Security (Tier 1)
  { name: 'Defense One', url: rss('https://www.defenseone.com/rss/all/'), type: 'geopolitical' },
  { name: 'Breaking Defense', url: rss('https://breakingdefense.com/feed/'), type: 'geopolitical' },
  { name: 'The War Zone', url: rss('https://news.google.com/rss/search?q=site:thedrive.com+%22the+war+zone%22+when:3d&hl=en-US&gl=US&ceid=US:en'), type: 'geopolitical' },
  { name: 'Defense News', url: rss('https://www.defensenews.com/arc/outboundfeeds/rss/?outputType=xml'), type: 'geopolitical' },
  { name: 'Janes', url: rss('https://news.google.com/rss/search?q=site:janes.com+when:3d&hl=en-US&gl=US&ceid=US:en'), type: 'geopolitical' },
  { name: 'CSIS', url: rss('https://www.csis.org/analysis?type=analysis'), type: 'geopolitical' },
  ...
  // Energy & Arms Control (Tier 2)
  { name: 'Arms Control Assn', url: rss('https://news.google.com/rss/search?q=site:armscontrol.org+when:7d&hl=en-US&gl=US&ceid=US:en'), type: 'energy' },
  { name: 'Bulletin of Atomic Scientists', url: rss('https://news.google.com/rss/search?q=site:thebulletin.org+when:7d&hl=en-US&gl=US&ceid=US:en'), type: 'energy' },
