...
const RECENT_SEARCHES_KEY = 'chainscope_recent_searches';
const MAX_RECENT = 8;
...
export class SearchModal {
  ...
  constructor(container: HTMLElement, options?: SearchModalOptions) {
    ...
    this.placeholder = options?.placeholder || 'Search news, DeFi, tokens, markets...';
    this.hint = options?.hint || 'News • DeFi • Crypto • Tokens • Markets • Yields • Protocols';
