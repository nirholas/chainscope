...
export class MapContainer {
  ...
  public setTrackedFlights(flights: TrackedFlight[], clusters: FlightCluster[] = []): void {
    if (this.useDeckGL) {
      this.deckGLMap?.setTrackedFlights(flights, clusters);
    } else {
      this.svgMap?.setTrackedFlights(flights, clusters);
    }
  }
  ...
  public setTrackedVessels(vessels: TrackedVessel[], clusters: VesselCluster[] = []): void {
    if (this.useDeckGL) {
      this.deckGLMap?.setTrackedVessels(vessels, clusters);
    } else {
      this.svgMap?.setTrackedVessels(vessels, clusters);
    }
  }
  ...
  public setBridgeFlows(flows: BridgeFlow[]): void {
    if (this.useDeckGL) {
      this.deckGLMap?.setBridgeFlows(flows);
    }
  }

  public setTvlGeoPoints(points: TvlGeoPoint[]): void {
    if (this.useDeckGL) {
      this.deckGLMap?.setTvlGeoPoints(points);
    }
  }

  public setValidatorNodes(nodes: ValidatorNode[]): void {
    if (this.useDeckGL) {
      this.deckGLMap?.setValidatorNodes(nodes);
    }
  }

  public setSecurityThreats(threats: SecurityThreat[]): void {
    if (this.useDeckGL) {
      this.deckGLMap?.setSecurityThreats(threats);
    } else {
      this.svgMap?.setSecurityThreats(threats);
    }
  }
  ...
  public updateActivityForEscalation(flights: TrackedFlight[], vessels: TrackedVessel[]): void {
    if (this.useDeckGL) {
      this.deckGLMap?.updateActivityForEscalation(flights, vessels);
    } else {
      this.svgMap?.updateActivityForEscalation(flights, vessels);
    }
  }
