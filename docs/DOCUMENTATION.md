...
AI-powered real-time DeFi crypto dashboard with an interactive 3D globe, live market data, protocol analytics, and AI-driven analysis. The front-end command center for [Chainscope](https://github.com/nirholas/chainscope).

> **Note:** HQ was originally a geopolitical intelligence dashboard but is now a **DeFi crypto dashboard** for Chainscope. The 3D globe UI remains, and some legacy world-events layers (conflict, military, etc.) still exist in the codebase, but the mission is now **DeFi, crypto markets, protocol analytics, and blockchain data**.

🌐 **[Live Demo: github.com/nirholas/chainscope](https://github.com/nirholas/chainscope)** | 💻 **[Tech Variant: github.com/nirholas/chainscope](https://github.com/nirholas/chainscope)**
...
![Chainscope Dashboard](../defis-dashboard.png)

## Platform Variants

Chainscope HQ runs two specialized variants from a single codebase:

| Variant | URL | Focus |
|---------|-----|-------|
| **🌍 Full** (default) | [defistech.vercel.app](https://defistech.vercel.app) | DeFi crypto dashboard — markets, protocols, on-chain data, macro signals, news |
| **💻 Tech** | [defistech.vercel.app](https://defistech.vercel.app) | AI/startup ecosystems, cloud infrastructure, tech events |
...
## Full Variant (DeFi Crypto Dashboard)

The primary variant is a DeFi crypto dashboard powering the Chainscope command center.

### Key Capabilities
- **Live Crypto Markets** - Token prices, trending coins, market movers, fear & greed index
- **DeFi Protocol Analytics** - TVL, fees, revenue, yields, DEX volume, top protocols
- **On-Chain Data** - ETF flows, stablecoin health, gas tracker, exchange flows, liquidations
- **Macro Signals** - FRED indicators, macro composite score, prediction markets
- **AI-Powered Analysis** - LLM-synthesized briefs, focal point detection, news clustering
- **Interactive 3D Globe** - Visual data layers for geographic context

### Core DeFi Panels
| Panel | Purpose |
|-------|---------|
| **Market Panel** | Live crypto/stock prices and market overview |
| **Fear & Greed** | Crypto market sentiment index |
| **ETF Flows** | Crypto ETF inflow/outflow tracking |
| **Stablecoin Health** | Stablecoin peg and supply monitoring |
| **DeFi Yields** | Top DeFi yield opportunities across protocols |
| **Macro Signals** | 7-signal macro composite radar |
| **AI Insights** | LLM-synthesized market brief with focal point detection |

### News Coverage
100+ curated sources across crypto, DeFi, markets, macro, and tech news.

> **Legacy layers:** Some world-events data layers (conflict zones, military bases, etc.) remain in the codebase from an earlier phase. They provide supplementary geographic context but are not the product's focus.

---

## Tech Monitor

The tech variant ([github.com/nirholas/chainscope](https://github.com/nirholas/chainscope)) provides specialized layers for technology sector monitoring.
...
| Layer | Description |
|-------|-------------|
| **Economic** | Financial center markers on the globe (stock exchanges, central banks) |
...
The Service Status panel tracks the operational health of external services that HQ users may depend on.
...
// App.ts
const header = `Chainscope v${__APP_VERSION__}`;
```
...
git clone https://github.com/nirholas/HQ.git
cd defis
...
- ✅ **Variant Switcher UI** - Compact orbital navigation between Chainscope and Tech Monitor
...
2. **Clone your fork** locally:
   ```bash
   git clone https://github.com/YOUR_USERNAME/HQ.git
   cd HQ
   ```
